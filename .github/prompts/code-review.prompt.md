...
> **Keep in sync.** This file and `.github/agents/code-review.md` share nearly all of their
> text, and both mirror the Claude-side config in `.claude/rules/`, `.claude/prompts/`, and
> `docs/review-checklist.md`. Change one, change the others.
