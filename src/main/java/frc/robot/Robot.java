...
import frc.lib.BatteryLogger;
import frc.lib.CANBusMonitor;
import frc.lib.CommandLogger;
import frc.lib.FaultMonitor;
import frc.lib.LoopTimeMonitor;
import frc.lib.MatchMetadataLogger;
import frc.lib.PhoenixSignalLogger;
...
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    ...
    // Register it manually so @AutoLogOutput annotations on its methods are picked up and
